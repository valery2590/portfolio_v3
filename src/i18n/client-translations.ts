...
export const clientTranslations = {
	es: {
		...
		projects: {
			title: 'Proyectos',
			project1: { title: 'Proyecto 1', description: 'Una aplicación web moderna con funcionalidades avanzadas y diseño responsivo.' },
			project2: { title: 'Proyecto 2', description: 'Plataforma de e-commerce con sistema de pagos integrado y panel de administración.' },
			project3: { title: 'Proyecto 3', description: 'Aplicación móvil para gestión de tareas con sincronización en tiempo real.' },
	...
	it: {
		...
		projects: {
			title: 'Progetti',
			project1: { title: 'Progetto 1', description: 'Un\'applicazione web moderna con funzionalità avanzate e design responsive.' },
			...
			project3: { title: 'Progetto 3', description: 'Applicazione mobile per la gestione delle attività con sincronizzazione in tempo reale.' },
